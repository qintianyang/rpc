...
public class ConfigLoader {
    ...
    public static ClientConfig loadClientProperties() throws IOException {
        ...
        clientConfig.setRetryTimes(Integer.valueOf(PropertiesLoader.getPropertiesStrDefault(retryTime, "3")));
        clientConfig.setRetryInterval(Integer.valueOf(PropertiesLoader.getPropertiesStrDefault(retryInterval, "1000")));
        clientConfig.setRegisterPassword(PropertiesLoader.getPropertiesStrDefault(registerPassword, "1234"));
        return clientConfig;
    }
    public static ServerConfig loadServerProperties() throws IOException{
        ...
        serverConfig.setRegisterPassword(PropertiesLoader.getPropertiesStrDefault(registerPassword, "1234"));
        return serverConfig;
    }
}